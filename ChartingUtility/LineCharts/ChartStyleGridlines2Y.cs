...
namespace ChartingUtility.LineCharts
{
    class ChartStyleGridlines2Y : ChartStyle2Y
    {
        ...
        public void AddChartStyle(TextBlock tbTitle, TextBlock tbXLabel, TextBlock tbYLabel, TextBlock tbY2Label)
        {
            Point pt = new Point();
            Line tick = new Line();
            double offset = 0;
            ...
            {
                pt = NormalizePoint2Y(new Point(Xmax, dy));
                tb = new TextBlock();
                tb.Text = dy.ToString();
